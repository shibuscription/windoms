...
変更点サマリ（最大5行）
- 第4章にToday日付ビュー（URL仕様・不正値フォールバック・日付ナビ）を追記
- 第4章にToday備考の3行折りたたみ / 展開仕様（最大高・内部スクロール）を追記
- 第20章実装済みに、Todayの日付移動・ミニカレンダー・未来日作成確認を追記
- 第20章実装済みに、Today備考の展開時スクロール補正を追記
- 既存仕様（1日1日誌、計画実績の非強制同期）との整合を維持
